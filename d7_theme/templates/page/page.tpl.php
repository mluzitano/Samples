...
<div id="page-wrapper">
  <div id="page" class="<?php print $classes; ?>">
    ...
    <?php if ($messages || $page['help']): ?>
      <div id="messages-help-wrapper" style="position: relative; z-index: 9999;">
        <div class="container clearfix">
          <?php print $messages; ?>
	...
	<?php
	    $class = '';
      if(isset($node)){
        if($node->nid == 97111 || $node->nid == 153291){
          $title = '';
        }
      }
	    ?>

    <div id="content-wrapper" <?php if(isset($node) && ($node->nid == 97111 || $node->nid == 153291)): ?>style="height:auto;padding-bottom:0px;"<?php endif; ?>><div class="container">
...
<?php if ($page['footer'] || $page['tertiary_content']): ?>
  <div id="footer-wrapper">
    <?php if ($page['tertiary_content'] || $page['tertiary_content_second']): ?>
      <div id="tertiary-content-wrapper">
        <div class="container clearfix">
          <?php print render($page['tertiary_content']); ?>
          <?php print render($page['tertiary_content_second']); ?>
        </div>
      </div>
    <?php endif; ?>
    <div class="container clearfix">
...
<?php if(isset($node) && ($node->nid == 97111 || $node->nid == 153291)):?>
<style tyle="text/css">
 .iframe-container{max-width: 60%}
</style>
<?php endif; ?>
